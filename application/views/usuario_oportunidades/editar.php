...
<div class="widget widget-gray widget-body-white">
    ...
    <form id="form_add" name="form_add" method="post" action="<?=base_url();?>i/potentials/edit_now">
		<div class="widget-body" style="padding: 10px 0 0;">
			...
			<div class="span6">
                            ...
                            <div class="control-group">
                                    ...
                                    <div class="controls"><input class="span12" id="nome_potencial" name="nome_potencial" type="text" value="<?=$rows->nome_potencial;?>" /></div>
                            </div>
                                        ...
                                        <select class="selectpicker span10" id="tipo_negocio" name="tipo_negocio"  data-style="btn-default">
                                            ...
                                            <? foreach($tipos_negocio_db as $tipos_negocio_db_item) { 
                                                if($tipos_negocio_db_item->id == $rows->tipo_negocio)
                                                    ...
                                                    $selected = "";                                                 
                                                echo '<option value="'.$tipos_negocio_db_item->id.'" '.$selected.'>'.$tipos_negocio_db_item->titulo.'</option>';                                               
                                            }
                                            ?>
                                        </select>
                                    </div>
                            ...
                            <div class="control-group">
                                    ...
                                    <div class="controls"><input class="span12" id="proximo_passo" name="proximo_passo" type="text" value="<?=$rows->proximo_passo;?>" /></div>
                            </div>
                                        ...
                                        <select class="selectpicker span10" id="tipo_fonte" name="tipo_fonte"  data-style="btn-default">
                                            ...
                                            <? foreach($tipos_fontes_contato_db as $tipos_fontes_contato_db_item) {
                                                if($tipos_fontes_contato_db_item->id == $rows->tipo_fonte)
                                                    ...
                                                    $selected = "";                                                 
                                                echo '<option value="'.$tipos_fontes_contato_db_item->id.'" '.$selected.'>'.$tipos_fontes_contato_db_item->titulo.'</option>';                                               
                                            }
                                            ?>
                                        </select>
                                    </div>
			...
			<div class="span6">
                            ...
                            <div class="control-group input-append">
                                ...
                                <input type="text" id="valor" name="valor" class="span6" value="<?=$rows->valor;?>" /> 
                            ...
                            <div class="control-group input-append">
                                ...
                                <input type="text" id="datepicker" name="data_expectativa_fechar" class="span6" value="<?=$rows->data_expectativa_fechar;?>" /> 
                                        ...
                                        <select class="selectpicker span10" id="tipo_estagio_venda" name="tipo_estagio_venda"  data-style="btn-default">
                                            ...
                                            <? foreach($tipos_estagio_venda_db as $tipos_estagio_venda_db_item) { 
                                                if($tipos_estagio_venda_db_item->id == $rows->tipo_estagio_venda)
                                                    ...
                                                    $selected = "";                                                 
                                                echo '<option value="'.$tipos_estagio_venda_db_item->id.'" '.$selected.'>'.$tipos_estagio_venda_db_item->titulo.'</option>';                                               
                                            }
                                            ?>
                                        </select>
                                    </div>
                        ...
                        <br />
                        <input type="hidden" name="id" id="id" value="<?=$rows->oportunidade_id;?>" />
