...
<div class="heading-buttons">
	<h2 class="glyphicons vcard"><i></i> <?=$title;?></h2>
        <span style="margin: 0;" class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?=lang('common_configuracoes_tipos_contas_ajuda');?>"><i></i></span>
	<div class="buttons pull-right">
		<a href="#modal-add" data-toggle="modal" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i> <?=lang('common_configuracoes_tipos_contas_label_adicionar');?></a>
	</div>
...
<div class="modal hide fade" id="modal-add">
	...
	<div class="modal-header">
		...
		<h3><?=lang('common_configuracoes_tipos_contas_label_adicionar');?></h3>
	</div>
	<!-- // Modal heading END -->
	
	<!-- Modal body -->
	<div class="modal-body">
            <form id="form_add" name="form_add" method="post" action="<?=base_url();?>i/config/accounttype_add">
		<div class="control-group">
                    <div class="controls"><input type="text" name="titulo_db" placeholder="<?=lang('common_configuracoes_tipos_contas_label_nome');?>" class="span3" /></div>
	...
	<div class="modal-footer">
		...
		<a href="#" id="btn-add" class="btn btn-primary"><?=lang('common_configuracoes_tipos_contas_label_adicionar');?></a>
	</div>
	<!-- // Modal footer END -->
...
<div class="modal hide fade" id="modal-edit">
	...
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		<h3><?=lang('common_configuracoes_tipos_contas_label_editar');?></h3>
	</div>
	<!-- // Modal heading END -->
	
	<!-- Modal body -->
	<div class="modal-body">
            <form id="form_edit" name="form_edit" method="post" action="<?php echo base_url();?>i/config/accounttype_edit">
...
<div class="modal hide fade" id="modal-delete">
	...
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		<h3><?=lang('common_configuracoes_tipos_contas_label_deletar');?></h3>
	</div>
	<!-- // Modal heading END -->
	
	<!-- Modal body -->
	<div class="modal-body">
            <form id="form_delete" name="form_delete" method="post" action="<?php echo base_url();?>i/config/accounttype_delete">
                <input type="hidden" id="tipodb_id" name="tipodb_id" value="" />
		<div class="control-group">
                    <div class="controls"><?=lang('common_configuracoes_tipos_contas_label_deletar_confirmar');?><br /><div id="div_html_group_delete"></div></div>
                </div>
            </form>
	</div>
	<!-- // Modal body END -->
