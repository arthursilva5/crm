...
$gwresult = mysql_query("SELECT * FROM tbl_faturas WHERE id=''");
...
/* captura as descrições da fatura */
$query_description = "SELECT invoiceid, description FROM tblinvoiceitems WHERE invoiceid='$invoiceid'";
$result_description = mysql_query($query_description);
$descricoes_invoice = "";
while($data_description = mysql_fetch_array($result_description)) {
	$descricoes_invoice .= $data_description["description"]."<br />";
}
